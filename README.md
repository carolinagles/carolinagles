...
|------|---------------------|--------------|
| [In Search of the Next 200 Oil Wells](https://github.com/carolinagles/datascience/blob/main/10.Machine_Learning_in_Business/OilyGiant_Company_en.ipynb) | This project focuses on identifying the best locations to open new oil wells in three regions using synthetic geological data and a linear regression model. The main goal is to maximize profits and minimize risks, ensuring the economic sustainability of the investment. | **Machine Learning in Business:** Business Metrics, Implementing New Functionality, Data Collection, Soft Skills Lessons: Business Thinking & Problem Solving. |  
| [Customer Churn Prediction for Beta Bank](https://github.com/carolinagles/datascience/blob/main/9.Supervised_learning/Beta_bank_en.ipynb) | The objective of this project is to predict whether a Beta Bank customer will leave the bank in the near future, using historical data on customer behavior and contract terminations. | **Supervised Learning:** Feature Preparation, Classification Metrics, Imbalanced Classification, Regression Metrics, Soft Skills Lessons: Task Management. |  
